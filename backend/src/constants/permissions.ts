...
export const PERMISSION_HIERARCHY: Record<string, string[]> = {
  ...
  // Sections
  MANAGE_SECTIONS: ['VIEW_SECTIONS', 'CREATE_SECTIONS', 'UPDATE_SECTIONS', 'DELETE_SECTIONS'],

  // Products
  MANAGE_PRODUCTS: ['VIEW_PRODUCTS', 'CREATE_PRODUCTS', 'UPDATE_PRODUCTS', 'DELETE_PRODUCTS'],
}
