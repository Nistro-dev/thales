...
const AdminUsersPage = lazy(() =>
  import("@/features/users/pages/AdminUsersPage").then((m) => ({
    default: m.AdminUsersPage,
  })),
);
const AdminUserDetailPage = lazy(() =>
  import("@/features/users/pages/AdminUserDetailPage").then((m) => ({
    default: m.AdminUserDetailPage,
  })),
);
const AdminReservationsPage = lazy(() =>
  import("@/features/reservations/pages/AdminReservationsPage").then((m) => ({
    default: m.AdminReservationsPage,
  })),
);
const AdminReservationDetailPage = lazy(() =>
  import("@/features/reservations/pages/AdminReservationDetailPage").then(
    (m) => ({ default: m.AdminReservationDetailPage }),
  ),
);
const QRScannerPage = lazy(() =>
  import("@/features/reservations/pages/QRScannerPage").then((m) => ({
    default: m.QRScannerPage,
  })),
);
const AdminDashboardPage = lazy(() =>
  import("@/features/stats").then((m) => ({ default: m.AdminDashboardPage })),
);
const AdminStatsPage = lazy(() =>
  import("@/features/stats").then((m) => ({ default: m.AdminStatsPage })),
);

// Products & Sections admin pages
const AdminSectionsPage = lazy(() =>
  import("@/features/sections").then((m) => ({ default: m.AdminSectionsPage })),
);
const AdminSectionDetailPage = lazy(() =>
  import("@/features/sections").then((m) => ({
    default: m.AdminSectionDetailPage,
  })),
);
const AdminProductsPage = lazy(() =>
  import("@/features/products/pages/AdminProductsPage").then((m) => ({
    default: m.AdminProductsPage,
  })),
);
const AdminProductDetailPage = lazy(() =>
  import("@/features/products/pages/AdminProductDetailPage").then((m) => ({
    default: m.AdminProductDetailPage,
  })),
);
const AdminProductNewPage = lazy(() =>
  import("@/features/products/pages/AdminProductNewPage").then((m) => ({
...
const AdminRolesPage = lazy(() =>
  import("@/features/roles/pages/AdminRolesPage").then((m) => ({
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: ROUTES.ADMIN_SECTION_DETAIL,
                element: (
                  <LazyPage>
          ...
          {
            element: (
              <RequireAuth permissions={[PERMISSIONS.MANAGE_PRODUCTS]} />
            ),
            children: [
              {
          ...
          {
            element: (
              <RequireAuth permissions={[PERMISSIONS.VIEW_RESERVATIONS]} />
            ),
            children: [
              {
          ...
          {
            element: (
              <RequireAuth permissions={[PERMISSIONS.VIEW_STATISTICS]} />
            ),
            children: [
              {
