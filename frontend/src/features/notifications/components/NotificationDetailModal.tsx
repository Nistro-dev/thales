...
const typeLabels: Record<NotificationType, string> = {
  ...
  RESERVATION_REFUNDED: "Réservation remboursée",
  RESERVATION_CHECKOUT: "Produit retiré",
  RESERVATION_RETURN: "Produit retourné",
  RESERVATION_REMINDER: "Rappel",
  RESERVATION_EXTENDED: "Réservation prolongée",
  RESERVATION_OVERDUE: "Retard",
  RESERVATION_EXPIRED: "Réservation expirée",
  CREDIT_ADDED: "Crédits ajoutés",
  CREDIT_REMOVED: "Crédits retirés",
