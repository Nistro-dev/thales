...
export function MyReservationsPage() {
  ...
  const hasActiveFilters =
    statusFilter !== "all" || sortBy !== "startDate" || sortOrder !== "desc";
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <CancelReservationDialog
        ...
        refundDeadlineHours={reservationToCancel?.refundDeadlineHours}
        creditsCharged={reservationToCancel?.creditsCharged}
      />
    </div>
  );
}
